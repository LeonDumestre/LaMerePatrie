...
module.exports = new Event("messageCreate", async (bot, message) => {
	...
	if (!command) return /*message.reply(`${args[0]} n'existe pas !`)*/

	let idCatCitation = "892330675422789722"
	let idCat2A = "882670135234678865"
	let idCatMatiere2A = "789256851023855637"
	let idCat1A = "882669976140546058"
	let idCatMatiere1A = "882637919163154442"
	let idCatDelegue = "789213580058427442"
	let idAdmin = "757922602319609927"
	...
	{	
		let reponseBOT  = await message.reply("Tu ne peux pas faire de commande ici, vas dans un endoit plus approprié")
