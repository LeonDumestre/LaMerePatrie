...
type EmittedInteractions = import('discord.js').CommandInteraction | import('discord.js').ContextMenuCommandInteraction
...
type InteractionsConstants = 'CHAT_INPUT_COMMAND_INTERACTION' | 'CONTEXT_MENU_INTERACTION' | 'BUTTON_INTERACTION' | 'SELECT_MENU_INTERACTION' | 'MODAL_SUBMIT_INTERACTION'
