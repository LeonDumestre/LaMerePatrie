...
module.exports = new Command({
    ...
    name: "avertissement",
	description: "Permet dde goulag de façon illimité pour avertissement",
...
//La commande n'est pas lancé
    ...
    //Si la personne est déjà au goulag
        ...
        embed.setColor("YELLOW").setTitle(`⚠️ AVERTISSEMENT ⚠️`).setDescription(msg).setFooter("Il reste : "+humanizeDuration(tempsRestant,{ round: true }, {language: 'fr'}))
